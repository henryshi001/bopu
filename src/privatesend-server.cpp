...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Bopu related functionality
...
/*
    ...
    allow endless transaction that would bloat Bopu and make it unusable. To
