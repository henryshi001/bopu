...
const char * const BITCOIN_CONF_FILENAME = "bopu.conf";
const char * const BITCOIN_PID_FILENAME = "bopud.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "bopu" is a composite category enabling all Bopu-related debug output
            if(ptrCategory->count(string("bopu"))) {
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty bopu.conf if it does not excist
    ...
    {
        // Don't overwrite existing settings so command line settings override bopu.conf
