    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Bopu Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bopu address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bopu: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Bopu Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bopu Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bopu Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bopu addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bopu addresses"));
    ...
    openAction->setStatusTip(tr("Open a bopu: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bopu Core help message to get a list with possible Bopu Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Bopu Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bopu network", "", count));
    } else {
...
{
    QString strTitle = tr("Bopu Core"); // default title
