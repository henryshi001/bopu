    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Bopu Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Bopu Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bopu-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bopu in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BOPU, 0.01 BOPU, 0.1 BOPU, 1 BOPU and 10 BOPU -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a href=\"https://docs.bopu.org/en/latest/wallets/bopucore/privatesend-instantsend.html\">PrivateSend documentation</a>."
        ));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Bopu Core is shutting down...") + "<br /><br />" +
