 ...
 *
 *   // network
 *   CBopuNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.bopu.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CBopuNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: BopuNetwork
// //   -- signature requirements : Key1(User)
// class CBopuNetworkVariable : public CGovernanceObject
// {
// private:
