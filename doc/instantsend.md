...
This mechanism has been integrated into Bitcore-Node-Bopu which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bopucoin/insight-api-bopu#web-socket-api](https://github.com/bopucoin/insight-api-bopu#web-socket-api)
* API: [https://github.com/bopucoin/insight-api-bopu#instantsend-transactions](https://github.com/bopucoin/insight-api-bopu#instantsend-transactions)
...
By default, the Bopu Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bopu Core daemon:
